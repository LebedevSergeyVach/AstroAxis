...
public class NotificationHelper {
    ...
    private static final String CHANNEL_ID = "AstroAxisNotification";
    private static final String CHANNEL_NAME = "AstroAxisNotification";
    ...
    public static void showNotification(Context context, String title, String message, Intent intent) {
        ...
        // Канал уведомлений для Android 8.0 и выше
