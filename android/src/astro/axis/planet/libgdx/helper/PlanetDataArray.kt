...
class PlanetDataArray {
    ...
    val theoryData: Array<Array<String>> = arrayOf(
    ...
    fun getPlanetData(planetName: String): Array<String> {
        return when (planetName.lowercase(Locale.getDefault())) {
            "mercury" -> dataMercury
            "venus" -> dataVenus
            "earth" -> dataEarth
            "mars" -> dataMars
